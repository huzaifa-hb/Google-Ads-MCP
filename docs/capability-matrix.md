...
| `create_campaign_draft` | `campaigns` | `mutate` | `operation_template` | GoogleAdsService.Mutate | `write` | no | Create a campaign draft. |
| `create_campaign_experiment` | `campaigns` | `mutate` | `operation_template` | GoogleAdsService.Mutate | `write` | no | Create a campaign experiment. |
...
| `create_ad_customizer_feed` | `feeds` | `mutate` | `operation_template` | GoogleAdsService.Mutate | `write` | no | Create ad customizer feed or attributes. |
| `create_dsa_page_feed` | `feeds` | `mutate` | `operation_template` | GoogleAdsService.Mutate | `write` | no | Create a Dynamic Search Ads page feed. |
...
| `create_listing_group_tree` | `shopping_pmax` | `mutate` | `operation_template` | GoogleAdsService.Mutate | `write` | no | Create a Shopping listing group tree. |
| `create_pmax_asset_group` | `shopping_pmax` | `mutate` | `operation_template` | GoogleAdsService.Mutate | `write` | no | Create a PMax asset group. |
