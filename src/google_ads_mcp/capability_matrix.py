...
from .tool_implementation import DIRECT_MUTATION_TOOLS, DIRECT_NEGATIVE_KEYWORD_TOOLS
...
def capability_matrix_markdown(rows: list[CapabilityRow]) -> str:
    lines = [
        ...
        "`src/google_ads_mcp/tool_config.py`, `src/google_ads_mcp/tool_implementation.py`, "
        "and `src/google_ads_mcp/capability_matrix.py`.",
        "",
